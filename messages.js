...
module.exports.welcome = `Hello and welcome to the PPTL Youth Slack Space to connect, share, and learn from each other. This is a place for you to be able to meet other youth to get some support and be lifted up by each other. Here are some things to keep in mind to make this the best experience for everyone:

1. We are not mental health professionals, so this is not designed to be group therapy. It is meant to be a resource and place to connect with other youth in a safe and uplifting space. 

2. If you are in crisis please go to https://www.iowacrisischat.org/.

3. Please be respectful of each other. Comments that include any hateful language or inappropriate pictures won’t be tolerated and will be deleted. Go out of your way to lift up each other instead.

4. Have fun, like a ridiculous amount of fun. Enjoy the cats, affirmations, and tacos. So many tacos and bad jokes.`;